...
import { classesService, attendanceService } from "@services/baseService";
...
const StudentDashboard = () => {
  ...
  const loadStudentData = async () => {
    ...
    if (assignedClass) {
      ...
      const classRecords = allAttendanceRecords.filter(
        (r) => r.classId === assignedClass.id
      );
              ...
              <Grid item xs={12} sm={3}>
                ...
                >
                  <CardContent sx={{ textAlign: "center" }}>
                    ...
                    <Typography
                      variant="h3"
                      sx={{ color: colors.highlight, fontWeight: 700 }}
                    >
                      {stats.absentDays}
                    </Typography>
                  </CardContent>
