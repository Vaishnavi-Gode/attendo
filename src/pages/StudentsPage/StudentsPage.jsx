...
import { studentsService, classesService } from "@services/baseService";
import { validateStudent } from "@utils/validations";
...
const StudentsPage = () => {
  ...
  const getSearchOptions = () => {
    switch (searchColumn) {
      ...
      case "roll":
        return students.map((s) => s.rollNumber);
      default:
        return students
          .map((s) => [`${s.firstName} ${s.lastName}`, s.email, s.rollNumber])
          .flat();
    }
  };
  ...
  const filteredStudents = students.filter((student) => {
    ...
    switch (searchColumn) {
      ...
      case "roll":
        return student.rollNumber.toLowerCase().includes(term);
      default:
        return (
